                                        ...
                                        ?>
                                            <tr id="urlItem_<?php echo $item['id'] ?>">
                                                ...
                                                <td class="text-center">
                                                    <a href="edit-comment.php?id=<?php echo $item['id'] ?>" class="btn btn-xs btn-primary" title="Edit item">Edit</a><button type="button" class="btn btn-xs btn-danger" title="Delete this item" onclick="deleteItem('<?php echo $item['id'] ?>')">Delete</button>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                    </tbody>
