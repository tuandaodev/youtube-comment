                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="landing_page"
                                           value="<?php echo urldecode($campaign['landing_page']) ?>" maxlength="512"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="custom_css"
                                              placeholder="Nhập CSS"><?php echo $campaign['custom_css'] ?? '' ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Button Text</label>
                                    <input class="form-control" name="btn_text" value="<?php echo $campaign['btn_text'] ?>"
...
function renderOptionItem($campaign_id, $type, $settings) {
    $temp = array_filter($settings, function ($item) use ($type) { return $item['type'] == $type; });
    $mapSettings = [];
...
?>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea class="form-control" name="header_html" rows="8" placeholder="Nhập Header HTML"><?php echo $mapSettings['header_html'] ?? '' ?></textarea>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label>Số Items</label>
            <input class="form-control" type="number" name="items_number"
                   value="<?php echo $mapSettings['items_number'] ?? MAX_ITEMS ?>" required
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input class="form-control" name="help_image" value="<?php echo $mapSettings['help_image'] ?? '' ?>"
                   placeholder="Nhập URL Image Hướng dẫn">
        </div>
    </div>
    <div class="col-md-12">
        <div class="form-group">
            <label>Help Video Iframe</label>
            <textarea class="form-control" name="help_video"
                      placeholder="Nhập Video Iframe share của youtube"><?php echo $mapSettings['help_video'] ?? '' ?></textarea>
        </div>
    </div>
    <div class="col-md-12">
